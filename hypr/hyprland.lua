...
hl.on("hyprland.start", function ()
    ...
    hl.exec_cmd("waybar")
    hl.exec_cmd("swaync")
    hl.exec_cmd("wl-paste --type text --watch cliphist store")   -- Armazena somente texto
    hl.exec_cmd("wl-paste --type image --watch cliphist store")  -- Armazena somente imagens
end)
